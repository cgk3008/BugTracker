...
namespace BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        {
            var ticketHistories = db.History.Include(t => t.Ticket).Include(t => t.User);
        ...
        public ActionResult Details(int? id)
        {
            ...
            TicketHistory ticketHistory = db.History.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,Changed,UserId")] TicketHistory ticketHistory)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Ticket, "Id", "Body", ticketHistory.TicketId);
        ...
        {
            TicketHistory ticketHistory = db.History.Find(id);
            db.History.Remove(ticketHistory);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
